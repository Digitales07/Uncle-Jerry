...
if(isset($_POST['submit']))
	{
		...
		if($d=='')
		{
			echo "<script>window.open('editpagecategories.php?dis=Discription is required','_self')</script>";
			exit();
		}
		
		if($n=='')
		{
			echo "<script>window.open('editpagecategories.php?name=Name is required','_self')</script>";
			exit();
		}
		...
		$queryc = "UPDATE category SET category_name='$n',category_description='$d' where category_id='$cid'";
...
$query = "SELECT * FROM category where category_id='$idcat'"; 
...
?>
                        ...
                        <div class="col-lg-4">
                        <form action="editpagecategories.php" method="post">
