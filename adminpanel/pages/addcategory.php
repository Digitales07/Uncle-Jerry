...
if(isset($_POST['submit']))
	{
		...
		if($t=="Primary")
		{
		$queryc = "INSERT INTO category ( category_name, category_description, category_type) VALUES ('$n','$d','$t')";
		}
		else 
		{
			$queryc = "INSERT INTO category ( category_name, category_description, category_type,category_parentID) VALUES ('$n','$d','$t','$c')";
		}
...
$query = "SELECT category_id,category_name FROM category where category_type='Primary'";
if ( $result = mysqli_query($conn,$query) ) {
    echo "<select name='pcategory' id='pcategory' style='float:right;'>";
